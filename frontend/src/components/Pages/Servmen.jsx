          ...
          <Table sx={{ minWidth: 650 }} aria-label="simple table">
            <TableHead className='bg-success'>
              <TableRow>
                ...
                <TableCell align="center" sx={{ color: "white" }}><strong>Mobile No.</strong></TableCell>
                <TableCell align="center" sx={{ color: "white" }}><strong>Area</strong></TableCell>
                <TableCell align="center" sx={{ color: "white" }}><strong>Email</strong></TableCell>
                <TableCell align="center" sx={{ color: "white" }}><strong>Service Provides</strong></TableCell>
                <TableCell align="center" sx={{ color: "white" }}><strong>Ratings(out of 5)</strong></TableCell>
                <TableCell align="center" sx={{ color: "white" }}><strong>Service Charge</strong></TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {rows.map((row) => (
                ...
                >
                  ...
                  <TableCell align="center">{row.serviceProvide}</TableCell>
